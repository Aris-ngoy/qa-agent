...
Launch behavior needs no per-platform capabilities — sessions open the bundle id / application id directly. See [Device capabilities](/guide/best-practices-appium-capabilities).
