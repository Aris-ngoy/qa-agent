...
Phase 1 is **local-only**. Everything — device automation, vision calls, catalog, reports — runs on your machine.
...
- Debugging device issues with full control (Argent CLI (`argent`) + runner logs).
