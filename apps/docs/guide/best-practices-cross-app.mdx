...
If the test should **not** auto-open your app, begin from the home screen or browser via `action open-url`. See [Device capabilities](/guide/best-practices-appium-capabilities).
