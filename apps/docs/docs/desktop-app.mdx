...
The Yoqa desktop app is the local host for device sessions, device browsing, apps/cases/runs, Manual Inspector, and Settings.
...
| **Settings → iOS toolchain** | Xcode installations and signing identities on this Mac |
