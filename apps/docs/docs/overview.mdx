...
Both modes use **Argent** under the hood (screenshots first, accessibility tree second, gestures, and app installs on iOS and Android). You bring your own vision model via [AI Providers](/docs/providers).
