...
5. Desktop: open Servers button left of Play → list / stop all / select stop|restart; Doctor tab → Open Diagnostics.
6. Settings → Diagnostics → Refresh / Repair safe issues.
